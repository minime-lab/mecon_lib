...
class TestTransformationFunctions(unittest.TestCase):
    ...
    def test_date(self):
        ...
        self.assertEqual(tf(date(2020, 1, 1)), date(2020, 1, 1))
        self.assertEqual(tf('2020-01-01 12:30:30'), date(2020, 1, 1))
        self.assertEqual(tf('2020-01-01'), date(2020, 1, 1))
    ...
    def test_day(self):
        ...
        self.assertEqual(tf('2020-01-31 12:30:30'), 31)
    ...
    def test_month(self):
        ...
        self.assertEqual(tf('2020-12-31 12:30:30'), 12)
    ...
    def test_hour(self):
        ...
        self.assertEqual(tf('2024-12-31 23:30:30'), 23)
    ...
    def test_minute(self):
        ...
        self.assertEqual(tf('2024-12-31 12:59:30'), 59)
    ...
    def test_day_of_week(self):
        ...
        self.assertEqual(tf('2023-07-17 12:30:30'), 'Monday')
